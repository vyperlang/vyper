...
class ArrayDefinition(_SequenceDefinition):
    ...
    def __init__(
        self, value_type, length, is_constant: bool = False, is_public: bool = False
    ) -> None:
...
class TupleDefinition(_SequenceDefinition):
    ...
    def __init__(self, value_type: tuple) -> None:
        super().__init__(value_type, len(value_type), f"{value_type}", is_constant=True)
