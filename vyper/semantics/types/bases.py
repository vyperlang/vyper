...
class BasePrimitive:
    ...
    def from_annotation(
        ...
        return cls._type(location, is_constant, is_public, is_immutable, is_assignable)
...
class MemberTypeDefinition(BaseTypeDefinition):
    ...
    def __init__(
        ...
        super().__init__(location, is_constant, is_public, is_immutable, is_assignable)
    ...
    def get_member(self, key: str, node: vy_ast.VyperNode) -> BaseTypeDefinition:
        if key in self.members:
            ...
            type_.is_assignable = self.is_assignable
            return type_
