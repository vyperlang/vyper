...
class BaseNode:
    __slots__: Union[str, Iterable[str]] = ("type",)
    type: str
...
class Module(BaseNode):
    __slots__: Union[str, Iterable[str]] = ("type", "body")
    type: str
    body: List[BaseNode]
...
class Def(BaseNode):
    __slots__: Union[str, Iterable[str]] = ("type", "name", "args", "body")
    type: str
    name: str
    args: List[str]
    body: List[BaseNode]
...
class When(BaseNode):
    __slots__: Union[str, Iterable[str]] = ("type", "condition", "body")
    type: str
    condition: BaseNode
    body: List[BaseNode]
...
class _BinOp(BaseNode):
    __slots__: Union[str, Iterable[str]] = ("type", "lhs", "rhs")
    type: str
    lhs: BaseNode
    rhs: BaseNode
...
class If(BaseNode):
    __slots__: Union[str, Iterable[str]] = ("type", "condition", "positive", "negative")
    type: str
    condition: BaseNode
...
class Repeat(BaseNode):
    __slots__: Union[str, Iterable[str]] = ("type", "memory", "start", "rounds", "body")
    type: str
    memory: int
    start: int
    rounds: int
...
class Sstore(BaseNode):
    __slots__: Union[str, Iterable[str]] = ("type", "register", "value")
    type: str
    register: int
    value: int
