...
symbol_map_runtime - Resolved values of compiler symbols in runtime bytecode (intended for use by tooling developers)
symbol_map         - Resolved values of compiler symbols in deployable bytecode (intended for use by tooling developers)
