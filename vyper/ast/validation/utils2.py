# some more validation utils
# this could be merged with other files in validation/ e.g. utils.py,
# but the way it is currently set up leads to circular imports.
