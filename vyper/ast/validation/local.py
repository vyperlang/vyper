...
from vyper.ast.environment import (
    CONSTANT_ENVIRONMENT_VARS,
    MUTABLE_ENVIRONMENT_VARS,
)
from vyper.ast.namespace import get_namespace
from vyper.ast.types.abstract import IntegerAbstractType
from vyper.ast.types.bases import DataLocation
from vyper.ast.types.function import (
    ContractFunction,
    FunctionVisibility,
    StateMutability,
)
from vyper.ast.types.indexable.sequence import (
    ArrayDefinition,
    TupleDefinition,
)
from vyper.ast.types.meta.event import Event
from vyper.ast.types.meta.struct import StructDefinition
from vyper.ast.types.utils import get_type_from_annotation
from vyper.ast.types.value.boolean import BoolDefinition
from vyper.ast.types.value.numeric import Uint256Definition
from vyper.ast.validation.annotation import StatementAnnotationVisitor
from vyper.ast.validation.base import VyperNodeVisitorBase
from vyper.ast.validation.utils import (
    get_common_types,
