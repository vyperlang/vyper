...
class Log2(BuiltinFunction):

    _id = "log2"
    _inputs = [("arg", DecimalT())]
    _return_type = DecimalT()
...
if lt1:
    res = -res
        ...
        variables_2 = {"x": VarInfo(DecimalT())}
        # Generate inline IR.
        new_ctx, log2_ir = generate_inline_function(
            code=vy_code,
            variables=variables,
            variables_2=variables_2,
            memory_allocator=context.memory_allocator,
        ...
        return IRnode.from_list(
            ["seq", placeholder_copy, log2_ir, new_ctx.vars["res"].pos],  # load x variable
            typ=BaseType("decimal"),
            location=MEMORY,
        )
