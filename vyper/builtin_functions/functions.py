...
from vyper.ast.types.abstract import (
...
from vyper.ast.types.bases import DataLocation, ValueTypeDefinition
from vyper.ast.types.indexable.sequence import ArrayDefinition
from vyper.ast.types.utils import get_type_from_annotation
from vyper.ast.types.value.address import AddressDefinition
from vyper.ast.types.value.array_value import (
...
from vyper.ast.types.value.numeric import (
    DecimalDefinition,
    Int128Definition,
    Int256Definition,
    Uint256Definition,
