...
from vyper.old_codegen.function_definitions.parse_external_function import (  # NOTE black/isort conflict
    parse_external_function,
)
from vyper.old_codegen.function_definitions.parse_internal_function import (  # NOTE black/isort conflict
