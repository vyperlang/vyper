...
class IRFunction:
    ...
    # Set by DretLoweringPass/DallocaLoweringPass: True if this function
    # threads the free-memory pointer through a hidden FMP param (i.e.
    # contains a dalloca/dret or invokes a callee that does). The hidden FMP
    # param is placed at the tail of the param list, immediately before
    # return_pc (if any). Functions on the `initial_fmp` fast path keep this
    # False.
    _needs_fmp: bool
