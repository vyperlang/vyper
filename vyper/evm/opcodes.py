...
#    fork choice rules)
_evm_versions = ("london", "paris", "shanghai", "cancun", "prague", "osaka")
...
OPCODES: OpcodeMap = {
    ...
    "BASEFEE": (0x48, 0, 1, 2),
    "BLOBHASH": (0x49, 1, 1, (None, None, None, 3, 3, 3)),
    "BLOBBASEFEE": (0x4A, 0, 1, (None, None, None, 2, 2, 2)),
    "POP": (0x50, 1, 0, 2),
    "MLOAD": (0x51, 1, 1, 3),
    "MSTORE": (0x52, 2, 0, 3),
    "MSTORE8": (0x53, 2, 0, 3),
    ...
    "GAS": (0x5A, 0, 1, 2),
    "JUMPDEST": (0x5B, 0, 0, 1),
    "MCOPY": (0x5E, 3, 0, (None, None, None, 3, 3, 3)),
    "PUSH0": (0x5F, 0, 1, 2),
    "PUSH1": (0x60, 0, 1, 3),
    "PUSH2": (0x61, 0, 1, 3),
    "PUSH3": (0x62, 0, 1, 3),
    ...
    "TLOAD": (0x5C, 1, 1, (None, None, None, 100, 100, 100)),
    "TSTORE": (0x5D, 2, 0, (None, None, None, 100, 100, 100)),
}
