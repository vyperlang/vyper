    ...
    assert foo["body"] == [
        {
            ...
            "value": {
                ...
                "attr": "counter",
                "type": "uint256",
                "value": {"ast_type": "Name", "id": "lib1", "type": "lib1.vy"},
    ...
    assert qux["body"] == [
        {
            ...
            "target": {
                "ast_type": "Attribute",
                "attr": "bars",
                "type": "DynArray[Bar declaration object, 10]",
                "value": {"ast_type": "Name", "id": "lib1", "type": "lib1.vy"},
        ...
        },
        {
            ...
            "target": {
                "ast_type": "Subscript",
                "slice": {"ast_type": "Int", "type": "int8", "value": 0},
                "type": "Bar declaration object",
                "value": {
                    "ast_type": "Attribute",
                    "attr": "bars",
                    "type": "DynArray[Bar declaration object, 10]",
                ...
                "variable_reads": [
                    {"access_path": [None], "module": "lib1.vy", "variable": "bars"}
                ],
                "variable_writes": [
                    {"access_path": [None], "module": "lib1.vy", "variable": "bars"}
                ],
                ...
                "args": [
                    {
                        "ast_type": "Attribute",
                        "attr": "Bar",
                        "type": "type(Bar declaration object)",
                        "value": {"ast_type": "Name", "id": "lib1", "type": "lib1.vy"},
                    }
                ],
                "ast_type": "Call",
                "func": {"ast_type": "Name", "id": "empty", "type": "(builtin) empty"},
                "keywords": [],
                "type": "Bar declaration object",
            },
        },
        {
            ...
            "target": {
                "ast_type": "Attribute",
                "attr": "items",
                "type": "Foo declaration object[2]",
                "value": {
                    "ast_type": "Subscript",
                    "slice": {"ast_type": "Int", "type": "int8", "value": 1},
                    "type": "Bar declaration object",
                    "value": {
                        "ast_type": "Attribute",
                        "attr": "bars",
                ...
                "variable_reads": [
                    {"access_path": [None, "items"], "module": "lib1.vy", "variable": "bars"}
                ],
                "variable_writes": [
                    {"access_path": [None, "items"], "module": "lib1.vy", "variable": "bars"}
                ],
                ...
                "args": [
                    {
                        ...
                        "type": "type(Foo declaration object[2])",
                        "value": {
                            "ast_type": "Attribute",
                            "attr": "Foo",
        ...
        },
        {
            ...
            "value": {"ast_type": "Decimal", "type": "decimal", "value": "10.0"},
        },
    ]
