...
They are currently xfail because lower_Name is not yet implemented.
"""
import pytest
...
# Mark all tests as xfail until lower_Name is implemented
pytestmark = pytest.mark.xfail(reason="lower_Name not implemented", strict=True)
