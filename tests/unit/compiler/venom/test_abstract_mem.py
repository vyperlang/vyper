...
def test_abstract_may_overlap():
    ...
    loc1 = MemoryLocationAbstract(source=source, segment=MemoryLocationSegment(offset=0, size=32))
    loc2 = MemoryLocationAbstract(source=source, segment=MemoryLocationSegment(offset=128, size=32))
