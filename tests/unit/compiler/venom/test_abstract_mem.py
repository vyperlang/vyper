...
def test_abstract_may_overlap():
    ...
    loc1 = MemoryLocationAbstract(op=op1, segment=MemoryLocationSegment(_offset=op1.offset, _size=32))
    loc2 = MemoryLocationAbstract(op=op2, segment=MemoryLocationSegment(_offset=op2.offset, _size=32))
