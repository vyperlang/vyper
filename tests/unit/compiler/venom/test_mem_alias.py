...
FULL_MEMORY_ACCESS = MemoryLocationConcrete(_offset=0, _size=None)
...
def test_may_alias_full_memory_access():
    ...
    assert not alias.may_alias(
        FULL_MEMORY_ACCESS, MemoryLocationConcrete.EMPTY
    ), "FULL_MEMORY_ACCESS should not alias with EMPTY_MEMORY_ACCESS"
    assert not alias.may_alias(
        MemoryLocationConcrete.EMPTY, FULL_MEMORY_ACCESS
    ), "FULL_MEMORY_ACCESS should not alias with EMPTY_MEMORY_ACCESS"
    ...
    loc1 = MemoryLocationConcrete(_offset=0, _size=32)
    assert not alias.may_alias(
        MemoryLocationConcrete.EMPTY, loc1
    ), "EMPTY_MEMORY_ACCESS should not alias with regular location"
    assert not alias.may_alias(
        loc1, MemoryLocationConcrete.EMPTY
    ), "EMPTY_MEMORY_ACCESS should not alias with regular location"

    assert not alias.may_alias(
        MemoryLocationConcrete.EMPTY, MemoryLocationConcrete.EMPTY
...
def test_may_alias_volatile():
    ...
    volatile_loc = MemoryLocationConcrete(_offset=0, _size=32, _is_volatile=True)
    regular_loc = MemoryLocationConcrete(_offset=0, _size=32)
    assert alias.may_alias(
    ...
    non_overlapping_loc = MemoryLocationConcrete(_offset=32, _size=32)
    assert not alias.may_alias(
...
def test_mark_volatile():
    ...
    loc1 = MemoryLocationConcrete(_offset=0, _size=32)
    loc2 = MemoryLocationConcrete(_offset=0, _size=32)
    loc3 = MemoryLocationConcrete(_offset=32, _size=32)
...
def test_may_alias_with_alias_sets():
    ...
    loc4 = MemoryLocationConcrete(_offset=0, _size=32)
...
def test_may_alias_edge_cases():
    ...
    loc4 = MemoryLocationConcrete(_offset=0, _size=32)
    loc5 = MemoryLocationConcrete(_offset=0, _size=32)
    loc6 = MemoryLocationConcrete(_offset=32, _size=32)
...
def test_may_alias_edge_cases2():
    ...
    volatile_loc = MemoryLocationConcrete(_offset=0, _size=32, _is_volatile=True)
    overlapping_loc = MemoryLocationConcrete(_offset=16, _size=32)
    assert alias.may_alias(
        volatile_loc, overlapping_loc
    ), "Volatile location should alias with overlapping location"

    loc2 = MemoryLocationConcrete(_offset=0, _size=64)
    loc3 = MemoryLocationConcrete(_offset=32, _size=64)
    ...
    loc4 = MemoryLocationConcrete(_offset=0, _size=32)
    loc5 = MemoryLocationConcrete(_offset=0, _size=32)
    loc6 = MemoryLocationConcrete(_offset=0, _size=32)
    alias._analyze_mem_location(loc4)
    alias._analyze_mem_location(loc5)
    alias._analyze_mem_location(loc6)
    volatile_loc2 = alias.mark_volatile(loc4)
