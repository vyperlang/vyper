...
def test_arithmetic(a: int128) -> int128:
    ...
    assert c.test_decimal(Decimal("18707220957835557353007165858768422651595.9365500927")) == [True, False]
    assert c.test_decimal(Decimal("-18707220957835557353007165858768422651595.9365500928")) == [False, True]
