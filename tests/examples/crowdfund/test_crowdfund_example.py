...
def test_crowdfund_example2(c, w3, w3_assert_tx_failed):
    a0, a1, a2, a3, a4, a5, a6 = w3.eth.accounts[:7]
    ...
    w3_assert_tx_failed(lambda: c.refund(transact={"from": a0}))
    c.refund(transact={"from": a3})
    w3_assert_tx_failed(lambda: c.refund(transact={"from": a3}))
