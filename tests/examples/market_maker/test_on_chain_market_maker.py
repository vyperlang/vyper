...
def test_initiate(w3, market_maker, erc20, w3_assert_tx_failed):
...
def test_owner_withdraw(w3, market_maker, erc20, w3_assert_tx_failed):
    ...
    w3_assert_tx_failed(lambda: market_maker.ownerWithdraw(transact={"from": a1}))
