...
PRICE_SIZE: constant(uint256) = 256 // (N_COINS - 1)
...
def add_liquidity(
    ...
    log AddLiquidity(
        provider=receiver, token_amounts=amounts_received, fee=d_token_fee, token_supply=token_supply, packed_price_scale=packed_price_scale
    )
...
def calc_token_amount(amounts: uint256[N_COINS], deposit: bool) -> uint256:
    ...
    @dev Includes fee.
    @param amounts Amounts of tokens being deposited or withdrawing
