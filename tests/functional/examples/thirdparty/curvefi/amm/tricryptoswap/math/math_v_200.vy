...
def newton_D(
    ...
    for i: uint256 in range(255):
        ...
        K0 = unsafe_div(
            ...
            D,
        )  # <-------- We can convert the entire expression using unsafe staticcall math.
...
def _snekmate_wad_exp(x: int256) -> uint256:
    ...
    y: int256 = unsafe_add(unsafe_mul(unsafe_add(value, 1346386616545796478920950773328), value) >> 96, 57155421644029726153956944680412240)
