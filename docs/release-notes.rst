...
- ternary operators by @charles-cooper (`#3398 <https://github.com/vyperlang/vyper/pull/3398>`_)
- ``raw_revert()`` builtin by @z80dev (`#3136 <https://github.com/vyperlang/vyper/pull/3136>`_)
- shift operators by @charles-cooper (`#3019 <https://github.com/vyperlang/vyper/pull/3019>`_)
- make ``send()`` gas stipend configurable by @emc415 (`#3158 <https://github.com/vyperlang/vyper/pull/3158>`_)
- use new ``push0`` opcode by @charles-cooper (`#3361 <https://github.com/vyperlang/vyper/pull/3361>`_)
- python 3.11 support by @charles-cooper (`#3129 <https://github.com/vyperlang/vyper/pull/3129>`_)
- drop support for python 3.8 and 3.9 by @tserg (`#3325 <https://github.com/vyperlang/vyper/pull/3325>`_)
- build for ``aarch64`` by @kelvinfan001 (`#2687 <https://github.com/vyperlang/vyper/pull/2687>`_)

Major refactoring PRs:

- refactor front-end type system by @charles-cooper (`#2974 <https://github.com/vyperlang/vyper/pull/2974>`_)
- merge front-end and codegen type systems by @charles-cooper (`#3182 <https://github.com/vyperlang/vyper/pull/3182>`_)
- simplify ``GlobalContext`` by @charles-cooper (`#3209 <https://github.com/vyperlang/vyper/pull/3209>`_)
- remove ``FunctionSignature`` by @tserg (`#3390 <https://github.com/vyperlang/vyper/pull/3390>`_)

Notable fixes:

- assignment when rhs is complex type and references lhs by @charles-cooper (`#3410 <https://github.com/vyperlang/vyper/pull/3410>`_)
- uninitialized immutable values by @charles-cooper (`#3409 <https://github.com/vyperlang/vyper/pull/3409>`_)
...
- call graph stability by @charles-cooper (`#3370 <https://github.com/vyperlang/vyper/pull/3370>`_)
- fix ``vyper-serve`` output by @tserg (`#3338 <https://github.com/vyperlang/vyper/pull/3338>`_)
- add ``custom:`` natspec tags by @charles-cooper (`#3403 <https://github.com/vyperlang/vyper/pull/3403>`_)
- add missing pc maps to ``vyper_json`` output by @tserg (`#3333 <https://github.com/vyperlang/vyper/pull/3333>`_)
- fix constructor context for internal functions by @charles-cooper (`#3388 <https://github.com/vyperlang/vyper/pull/3388>`_)
- add deprecation warning for ``selfdestruct`` usage by @pcaversaccio (`#3372 <https://github.com/vyperlang/vyper/pull/3372>`_)
- add bytecode metadata option to vyper-json by @tserg (`#3117 <https://github.com/vyperlang/vyper/pull/3117>`_)
- fix compiler panic when a ``break`` is outside of a loop by @trocher (`#3177 <https://github.com/vyperlang/vyper/pull/3177>`_)
- fix complex arguments to builtin functions by @tserg (`#3167 <https://github.com/vyperlang/vyper/pull/3167>`_)
- add support for all types in ABI imports by @benber86 (`#3154 <https://github.com/vyperlang/vyper/pull/3154>`_)
- disable uadd operator by @charles-cooper (`#3174 <https://github.com/vyperlang/vyper/pull/3174>`_)
- block bitwise ops on decimals by @charles-cooper (`#3219 <https://github.com/vyperlang/vyper/pull/3219>`_)
- raise ``UNREACHABLE`` by @emc415 (`#3194 <https://github.com/vyperlang/vyper/pull/3194>`_)
- allow enum as mapping key by @tserg (`#3256 <https://github.com/vyperlang/vyper/pull/3256>`_)
- block boolean ``not`` operator on numeric types by @trocher (`#3231 <https://github.com/vyperlang/vyper/pull/3231>`_)
- enforce that loop's iterators are valid names by @trocher (`#3242 <https://github.com/vyperlang/vyper/pull/3242>`_)
- fix typechecker hotspot by @charles-cooper (`#3318 <https://github.com/vyperlang/vyper/pull/3318>`_)
- rewrite typechecker journal to handle nested commits by @charles-cooper (`#3375 <https://github.com/vyperlang/vyper/pull/3375>`_)
- fix missing pc map for empty functions by @charles-cooper (`#3202 <https://github.com/vyperlang/vyper/pull/3202>`_)
- guard against iterating over empty list in for loop by @tserg (`#3197 <https://github.com/vyperlang/vyper/pull/3197>`_)
- skip enum members during constant folding by @tserg (`#3235 <https://github.com/vyperlang/vyper/pull/3235>`_)
- bitwise ``not`` constant folding by @tserg (`#3222 <https://github.com/vyperlang/vyper/pull/3222>`_)
- allow accessing members of constant address by @tserg (`#3261 <https://github.com/vyperlang/vyper/pull/3261>`_)
- guard against decorators in interface by @tserg (`#3266 <https://github.com/vyperlang/vyper/pull/3266>`_)
- fix bounds for decimals in some builtins by @trocher (`#3283 <https://github.com/vyperlang/vyper/pull/3283>`_)
- length of literal empty bytestrings by @tserg (`#3276 <https://github.com/vyperlang/vyper/pull/3276>`_)
- block ``empty()`` for HashMaps by @tserg (`#3303 <https://github.com/vyperlang/vyper/pull/3303>`_)
- fix type inference for empty lists by @tserg (`#3377 <https://github.com/vyperlang/vyper/pull/3377>`_)
- disallow logging from ``pure``, ``view`` functions by @charles-cooper (`#3424 <https://github.com/vyperlang/vyper/pull/3424>`_)
- improve optimizer rules for comparison operators by @charles-cooper (`#3412 <https://github.com/vyperlang/vyper/pull/3412>`_)
- deploy to ghcr on push by @charles-cooper (`#3435 <https://github.com/vyperlang/vyper/pull/3435>`_)
- add note on return value bounds in interfaces by @pcaversaccio (`#3205 <https://github.com/vyperlang/vyper/pull/3205>`_)
- index ``id`` param in ``URI`` event of ``ERC1155ownable`` by @pcaversaccio (`#3203 <https://github.com/vyperlang/vyper/pull/3203>`_)
- add missing ``asset`` function to ``ERC4626`` built-in interface by @pcaversaccio (`#3295 <https://github.com/vyperlang/vyper/pull/3295>`_)
- clarify ``skip_contract_check=True`` can result in undefined behavior by @charles-cooper (`#3386 <https://github.com/vyperlang/vyper/pull/3386>`_)
- add ``custom`` NatSpec tag to docs by @pcaversaccio (`#3404 <https://github.com/vyperlang/vyper/pull/3404>`_)
- fix ``uint256_addmod`` doc by @trocher (`#3300 <https://github.com/vyperlang/vyper/pull/3300>`_)
- document optional kwargs for external calls by @benber86 (`#3122 <https://github.com/vyperlang/vyper/pull/3122>`_)
- remove ``slice()`` length documentation caveats by @helloibis (`#3152 <https://github.com/vyperlang/vyper/pull/3152>`_)
- fix docs of ``blockhash`` to reflect revert behaviour by @ToonVanHove (`#3168 <https://github.com/vyperlang/vyper/pull/3168>`_)
- improvements to compiler error messages by @tserg, @benber86 and @trocher (`#3121 <https://github.com/vyperlang/vyper/pull/3121>`_, `#3134 <https://github.com/vyperlang/vyper/pull/3134>`_, `#3312 <https://github.com/vyperlang/vyper/pull/3312>`_, `#3304 <https://github.com/vyperlang/vyper/pull/3304>`_, `#3240 <https://github.com/vyperlang/vyper/pull/3240>`_, `#3264 <https://github.com/vyperlang/vyper/pull/3264>`_, `#3343 <https://github.com/vyperlang/vyper/pull/3343>`_, `#3307 <https://github.com/vyperlang/vyper/pull/3307>`_, `#3313 <https://github.com/vyperlang/vyper/pull/3313>`_ and `#3215 <https://github.com/vyperlang/vyper/pull/3215>`_)
