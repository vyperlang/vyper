...
* add ``abi_decode`` builtin (`#2882 <https://github.com/vyperlang/vyper/pull/2882>`_)
...
* fix: type inference and annotation of arguments for builtin functions (`#2817 <https://github.com/vyperlang/vyper/pull/2817>`)
...
Many other small bugfixes and refactoring also made it into this release! Special thanks to @tserg and @pandadefi for contributing several important bugfixes, refactoring and features to this release!
